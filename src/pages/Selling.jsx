  ...
  return (
    <div className="font-sans">
      <Layout>
        ...
        <section className='w-full h-64 flex flex-col items-center justify-center text-gray-300 gap-5'>
          <h1 className='font-bold text-5xl text-gray-300'>Upload Your Digital Assets</h1>
